...
/**
 * MODO DE USO DO SistemaHelpDesk.ux.TextMaskCore
 *
 * Métodos:
 ...
 *        var mask = new SistemaHelpDesk.ux.TextMask('999.999.999-99', false);
 ...
 *        var mask = new SistemaHelpDesk.ux.TextMask('R$ #9.999.990,00', true);
...
Ext.define('SistemaHelpDesk.ux.TextMaskCore', {
 ...
 **/
Ext.util.Format.TextMask = new SistemaHelpDesk.ux.TextMaskCore();
 ...
 **/
Ext.util.Format.MoneyMask = new SistemaHelpDesk.ux.TextMaskCore('', true);
