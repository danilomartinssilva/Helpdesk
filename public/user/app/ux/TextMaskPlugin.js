...
/**
 * MODO DE USO DO SistemaHelpDesk.ux.TextMaskPlugin (ptype: 'textmask')
 *
...
Ext.require(['SistemaHelpDesk.ux.TextMaskCore'])

Ext.define('SistemaHelpDesk.ux.TextMaskPlugin',
{
	...
	init: function(cp)
	{
		...
		cp.textMask = new SistemaHelpDesk.ux.TextMaskCore(cp.mask, cp.money);
...
/**
 * MODO DE USO DO SistemaHelpDesk.ux.form.MaskDateField (xtype: 'maskdatefield')
 *
 * var campo = new SistemaHelpDesk.ux.form.MaskTextField({
...
Ext.define('SistemaHelpDesk.ux.form.MaskDateField', {
	...
	initComponent: function(){
		...
		SistemaHelpDesk.ux.form.MaskDateField.superclass.initComponent.apply(this, arguments);
		this.textMask = new SistemaHelpDesk.ux.TextMask(this.mask);
		this.textMask.blankChar = '_';
	},
	onRender: function(){
		SistemaHelpDesk.ux.form.MaskDateField.superclass.onRender.apply(this, arguments);
		this.hiddenField = this.inputEl.insertSibling({
			tag: 'input',
			type: 'hidden',
			name: this.name,
...
//Ext.reg('maskdatefield', SistemaHelpDesk.ux.form.MaskDateField);
 ...
 **/
//Ext.reg('datefield', SistemaHelpDesk.ux.form.MaskDateField);